/*
 * peko_console.h
 * Types, constants, and function declarations for the Peko console library.
 * Covers fd I/O, terminal input, and console setup.
 */

#ifndef PEKO_CONSOLE_H
#define PEKO_CONSOLE_H
...
/* -------------------------------------------------------------------------
 * Standard fd constants. These match the Fd module values in main.peko.
 * ---------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------
 * Open flag constants. These match the FdFlags module values in main.peko.
 * ---------------------------------------------------------------------- */
