                              ...
                              void           *data)
{
     ...
     * context. current_client is no longer written here. Writing the fd
     * through a raw interior pointer is unsafe because the WebSocket the
     * pointer addresses may move during the blocking reads. */
    (void)current_client;
